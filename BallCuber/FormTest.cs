...
namespace Ballcuber
{
    public partial class FormTest : Form
    {
        ...
        {
            var url = Path.Combine(Path.GetDirectoryName(this.GetType().Assembly.Location), "alg.cubing.net", "index.html") + "?type=reconstruction&title=Ballcuber&puzzle=4x4x4&view=playback";
